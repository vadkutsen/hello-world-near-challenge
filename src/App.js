...
export default function App() {
  ...
  if (!window.walletConnection.isSignedIn()) {
    return (
      <main>
        <h1>Welcome to my NEAR Hello World app!</h1>
        <p>
  ...
  return (
    ...
    <>
      ...
      <main>
        ...
        <p>
          Look at that! My first NEAR Hello World dapp!
        </p>
        <p>
          To keep learning along with me, check out <a target="_blank" rel="noreferrer" href="https://docs.near.org">the NEAR docs</a> or look through some <a target="_blank" rel="noreferrer" href="https://examples.near.org">example apps</a>.
        </p>
      </main>
